                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-12 lg:p-16">
                        <Reveal>
                            ...
                            <h2 className="text-4xl lg:text-5xl font-bold font-display text-white mb-6 leading-tight">
                                Equip your next <br /> ambitious project.
                            </h2>
                            <p className="text-lg text-gray-300 max-w-md leading-relaxed">
                                Create an account to track orders, save your favorite items, and get exclusive member deals.
                            </p>
                        </Reveal>
                    </div>
                </div>
                    ...
                    <div className="w-full max-w-md space-y-8">
                        <Reveal delay={0.1}>
                            <div className="text-center lg:text-left">
                                <h1 className="text-3xl font-bold font-display text-slate-900 dark:text-white mb-2">Create Account</h1>
                                <p className="text-text-secondary">Join HardwarePro today.</p>
                            </div>
                        </Reveal>
                        ...
                        <Reveal delay={0.2}>
                            <form action={formAction} className="space-y-4">
                                <div className="space-y-1">
                                    <label className="block text-sm font-bold text-slate-700 dark:text-gray-200">Full Name</label>
                            ...
                            <p className="mt-8 text-center text-text-secondary">
                                ...
                                <Link href="/login" className="text-primary hover:text-primary-dark font-bold hover:underline transition-colors">
                                    Sign in
                                </Link>
                            </p>
                        </Reveal>
